...
function prev() {
    ...
    if (films[counter] != null) {
        ...
        durata.innerHTML ="Durata: " + films[counter].durata; //durata
        anno.innerHTML ="Anno: " + films[counter].anno; //anno  
        genere.innerHTML ="Genere: " + films[counter].genere; //genere
    }else counter++;
}
